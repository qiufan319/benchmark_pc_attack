...
def defend(data_root, one_defense):
    ...
    save_name = '{}_{}'.format(one_defense, 'de.npz')
    ...
    if test_pc.shape[-1]!=3:
        test_pc=test_pc.transpose(0,2,1)
    # defend
    all_defend_pc = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', type=str, default='/home/jqf/桌面/benchmark_pc_attack1-master（复件）/baselines/attack_scripts/results/mn40_1024/GEOA3/GEO.npz',
                        help='the npz data to defend')
    parser.add_argument('--defense', type=str, default='srs',
                        choices=['', 'srs', 'sor', 'dup'],
