...
sys.path.append(os.path.join(root_path, 'EOP'))
import numpy as np
import EOP.dis_utils_torch
    ...
    #Add gradients
            ...
            if target_att == False:
                ...
                if cur_class == tar_cls:
                    # print('\nCurrent prediction: ', cur_class,'Target class: ', tar_cls,' Success!')
                    return state,best_img,ori_logits,max_other_logits
