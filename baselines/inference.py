...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_root', type=str,
                        default=r'baselines/data/attack_data.npz')
    ...
    parser.add_argument('--dataset', type=str, default='hybrid_training', metavar='N',
    ...
    if args.mode == 'target':
        ...
        test_set = ModelNet40(args.data_root, num_points=args.num_points,
                              ...
                              augmentation=False)
    # test_set.data=test_set.data.transpose(0,2,1)
