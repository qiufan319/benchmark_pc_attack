...
BEST_WEIGHTS = {
    ...
    'remesh_mn40': {
        1024: {
            'pointnet': 'baselines/pretrain/remesh_mn40/pointnet.pth',
            'pointnet2': 'baselines/pretrain/remesh_mn40/pointnet2.pth',
            'pointconv': 'baselines/pretrain/remesh_mn40/pointconv.pth',
            'dgcnn': 'baselines/pretrain/remesh_mn40/dgcnn.pth',
        },
    },
    # trained on mn40 + ONet optimized mn40
    'opt_mn40': {
        1024: {
            'pointnet': 'baselines/pretrain/opt_mn40/pointnet.pth',
            'pointnet2': 'baselines/pretrain/opt_mn40/pointnet2.pth',
            'pointconv': 'baselines/pretrain/opt_mn40/pointconv.pth',
            'dgcnn': 'baselines/pretrain/opt_mn40/dgcnn.pth',
        },
    },
    # trained on mn40 + ConvONet optimized mn40
    'conv_opt_mn40': {
        1024: {
            'pointnet': 'baselines/pretrain/conv_opt_mn40/pointnet.pth',
            'pointnet2': 'baselines/pretrain/conv_opt_mn40/pointnet2.pth',
            'pointconv': 'baselines/pretrain/conv_opt_mn40/pointconv.pth',
            'dgcnn': 'baselines/pretrain/conv_opt_mn40/dgcnn.pth',
        },
    },
}
